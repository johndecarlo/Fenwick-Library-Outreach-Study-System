...
public interface RemoteDBManager {
    ...
    // get the unique id which the database uses to identify students, different
    // from student id for security

    boolean addUser(int id, String username, String password /* add more values as student info decided on */ );
    ...
    // manage study location, int would be some combination of floor and table
    // number
    // system would check if table is available, and would return false to editing
    // if not
